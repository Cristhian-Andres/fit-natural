    ...
    <footer className="bg-brand-700 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p className="text-brand-200 text-sm">
          By @ <span className="text-white font-semibold">Cristhian Luna</span>
        </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            aria-label="Facebook de Cristhian Luna"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram de Cristhian Luna"
            className="text-brand-300 hover:text-white transition-colors"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn de Cristhian Luna"
            className="text-brand-300 hover:text-white transition-colors"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
